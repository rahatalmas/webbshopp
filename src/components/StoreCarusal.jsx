...
const StoreCarusal = ({ stores, interval = 4000 }) => {
  ...
  useEffect(() => {
    setSlides(chunkStores(stores, itemsPerSlide));
    setCurrent(0); // reset to first
  }, [itemsPerSlide, stores]);
